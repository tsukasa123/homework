...
<?php $results = mysqli_query($con, "SELECT * FROM itemlist"); ?>
    ...
    <div class="container">
        <div class="col-12 clearfix mb-2">
            <a href="4_add.php" class="float-right btn-primary text-light px-2 py-2">Add New</a>
        </div>

        <div class="col-12 form-group">
            <form action="4_search.php" method="post" class="d-flex py-4 px-2" style="background-color: #add0f7;">
                <div class="input-group mr-2">
                    <input type="text" name="search-name" class="form-control" placeholder="Name">
                </div>
                <div class="input-group mr-2">
                    <input type="text" name="search-code" class="form-control" placeholder="Code">
                </div>
                <div class="input-group">
                    <button type="submit" name="search" class="btn btn-secondary mr-2">Search</button>
